  ...
  if (!isAdmin && !pinUnlocked) {
    return (
      <div style={{ textAlign:'center', padding:'40px 20px' }}>
        ...
        {showPinModal && <PinModal title="Gastos" subtitle="PIN del proyecto" correctPin={project?.pin || '1234'} pinHash={project?.pinHash} onSuccess={() => { setPinUnlocked(true); setShowPinModal(false) }} onCancel={() => setShowPinModal(false)} />}
      </div>
    )
  }
