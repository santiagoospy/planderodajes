/**
 * ExportView — stub (migration in progress)
 * TODO: Extract full implementation from legacy index.html
 */
export default function ExportView({ onBack, ...props }) {
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] flex flex-col items-center justify-center p-8 text-center">
      <div className="text-lg font-bold text-[var(--text-primary)] font-[Inter] mb-2">Export</div>
